@echo off
REM Install PRPROMPTS Claude Code Commands
...
echo.
echo [94m==================================================[0m
echo [94m PRPROMPTS Claude Code Commands Installer[0m
echo [94m==================================================[0m
echo.
...
copy /Y "%REPO_DIR%\.claude\prompts\generate-prd.md" "%CONFIG_DIR%\prompts\" >nul
copy /Y "%REPO_DIR%\.claude\prompts\auto-generate-prd.md" "%CONFIG_DIR%\prompts\" >nul
copy /Y "%REPO_DIR%\.claude\prompts\generate-prd-from-files.md" "%CONFIG_DIR%\prompts\" >nul
copy /Y "%REPO_DIR%\.claude\prompts\analyze-prd.md" "%CONFIG_DIR%\prompts\" >nul
copy /Y "%REPO_DIR%\.claude\prompts\prprompts-generator.md" "%CONFIG_DIR%\prompts\" >nul
copy /Y "%REPO_DIR%\.claude\prompts\phase-1-core.md" "%CONFIG_DIR%\prompts\" >nul
copy /Y "%REPO_DIR%\.claude\prompts\phase-2-quality.md" "%CONFIG_DIR%\prompts\" >nul
copy /Y "%REPO_DIR%\.claude\prompts\phase-3-demo.md" "%CONFIG_DIR%\prompts\" >nul
copy /Y "%REPO_DIR%\.claude\prompts\single-file-generator.md" "%CONFIG_DIR%\prompts\" >nul

REM Copy config file
echo [92mCreating config.yml...[0m
copy /Y "%REPO_DIR%\.claude\config.yml" "%CONFIG_DIR%\" >nul
